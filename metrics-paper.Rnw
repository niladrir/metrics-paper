...
# lineup.dat
metrics.dat <- dat.pos %>% group_by(pos.1, pos.2) %>% summarize(
...
<<lp-box-dist, dependson='lp-box-dist-simu', echo=FALSE,  fig.width=4, fig.height = 4.5, out.width='\\textwidth'>>=
