...
lps <- read.table("data/dat_turk2_100_450_12_3.txt", header=TRUE)
...
dat <- read.table("data/dat_turk2_100_25_5_1.txt", header = TRUE) #plot_turk2_100_350_12_3.png
dat.m <- melt(dat, id = "X")
...
dat <- read.table("data/dat_turk1_100_0_5_2.txt", header = T)  ## plot_turk1_100_8_12_2
