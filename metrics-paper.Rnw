...
<<lp-box-dist-simu, dependson='lp-turk1-distr', echo=FALSE>>=
dat.pos <- expand.grid(pos.1 = 1:20, pos.2 = 1:20)

# lineup.dat
metrics.dat <- ddply(dat.pos, .(pos.1, pos.2), summarize, 
                     box.dist = box_dist(lineup.dat[lineup.dat$.sample == pos.1, ],
                                         lineup.dat[lineup.dat$.sample == pos.2, ],
                                         lineup.dat=lineup.dat))
...
<<lp-box-dist, dependson='lp-box-dist-simu', fig.width=, fig.height = , out.width='\\textwidth'>>=
