...
\hh{XXX to be answered: how are these distance metrics chosen, how well do they work in general situations? At the moment the distances seem like they are tailored for very specific examples in very specific designs.}
\begin{figure}[hbtp]
\centering
