...
\section*{Details of Distance Metrics}\label{sec:distmetdetails}
...
\section*{Effect of the Number of Bins on Distance} \label{sec:nbin}
...
\section*{Description of MTurk Data Collection}
