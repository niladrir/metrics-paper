...
The distance between the plots in these lineups were calculated using the distance measures defined above. The method discussed in Section \ref{sec:dist} was used to compute the mean distance of the true plot from the null plots and the mean distances of the null plots. To measure the difficulty of a lineup, two different statistics were calculated using the mean distances:
\begin{enumerate}
