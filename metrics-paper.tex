...
\centering
\subfigure[]{
\includegraphics[scale=0.55]{largep-lineup-new-1.pdf}
\label{t2comp_1}
}
\subfigure[]{
\includegraphics[scale=0.55]{sep-dist-largep-new-1.pdf}
\label{t2comp_1}
}
\subfigure[]{
\includegraphics[scale=0.55]{bin-dist-largep-6-4-new-1.pdf}
\label{t2comp_2}
}
%\subfigure[]{
%\includegraphics[scale=0.55]{distribution-bin-dist-8-2-exp2.pdf}
...
\label{lp-exp}
	\vspace{-.1in}
\caption[Optional caption for list of figures]{Plot showing the lineup in (a) and the distribution of different distance metrics : separation based distance in (b) and  binned distance with 6 and 4 bins in x and y axis respectively in (d). }
%{Caption of subfigures \subref{fig:subfig1}, \subref{fig:subfig2} and \subref{fig:subfig3}}
\end{figure}
