...
A number of different distance measures were examined. We initially started with several candidates that generically measure plot distance, but since revised the candidate list to take into accoutn specific features of the plots that were used in the experiments. 
...
\label{plottype}
	\vspace{-.1in}
\caption[Optional caption for list of figures]{Comparison of two lineups: scatterplots in (a) and scatterplots with a regression line overlaid in (b). The raw data is same for the lineups. The presence of regression line may affect the decision of human subjects.  }
%{Caption of subfigures \subref{fig:subfig1}, \subref{fig:subfig2} and \subref{fig:subfig3}}
\end{figure}
