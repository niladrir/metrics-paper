...
\subfigure[]{
\includegraphics[scale=0.7]{bin-dist-largep-100-0-2-3-2.pdf}
\label{t2comp_1}
}
\subfigure[]{
\includegraphics[scale=0.7]{mod-sep-dist-largep-100-0-2-3-2.pdf}
\label{t2comp_2}
}
\subfigure[]{
\includegraphics[scale=0.7]{sep-dist-largep-100-0-2-3-2.pdf}
\label{t2comp_1}
}
\label{lp-exp}
	\vspace{-.1in}
