...
\centering
\subfigure[]{
\includegraphics[scale=0.55]{turk1-diff-bin-prop.pdf}
\label{t1bin_1}
}
\subfigure[]{
\includegraphics[scale=0.55]{turk1-grtr-bin-prop.pdf}
\label{t1bin_2}
}
\label{turk1-bin}
	\vspace{-.1in}
...
\centering
\subfigure[]{
\includegraphics[scale=0.55]{largep-diff-bin-prop.pdf}
\label{lpcomp_1}
}
\subfigure[]{
\includegraphics[scale=0.55]{largep-grtr-bin-prop.pdf}
\label{lpcomp_2}
}
\label{lp-comp}
	\vspace{-.1in}
