...
\centering 
\begin{tabular}{ll c  p{3cm} l c p{2.5cm}} 
\hline
 Type of Data & Observed Plot && Null Generating Mechanism & Difference && Preferable number of bins \\ %[0.5ex] % inserts table %heading 
\hline
 Linear association & \begin{minipage}[h]{1.5cm} \begin{center} \scalebox{0.25}{\includegraphics{bin-select-data1.pdf}} \end{center} \end{minipage} && Permutation &  \begin{minipage}[h]{1.5cm} \begin{center} \scalebox{0.25}{\includegraphics{bin-select-plot1.pdf}} \end{center} \end{minipage} &&           \hspace{0.8cm} small\\
 \hline
