...
%\begin{figurehere}
   \centering
       \includegraphics[width=2.3in]{bin-example-1.pdf}
         \includegraphics[width = 2.6in]{bin-example-2.pdf}
%	\vspace{-.2in}
