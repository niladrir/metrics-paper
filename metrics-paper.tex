...
\centering
\subfigure[]{
\includegraphics[scale=0.55]{lineup-high-prop-neg-diff.pdf}
\label{t1comp_1}
}
\subfigure[]{
\includegraphics[scale=0.55]{distribution-box-dist-exp1.pdf}
\label{t1bin_1}
}
\subfigure[]{
\includegraphics[scale=0.55]{distribution-bin-dist-2-8-exp1.pdf}
\label{t1bin_1}
}
\subfigure[]{
\includegraphics[scale=0.55]{distribution-bin-dist-2-2-exp1.pdf}
\label{t1bin_1}
}
\label{turk1-exp}
	\vspace{-.1in}
...
\centering
\subfigure[]{
\includegraphics[scale=0.55]{lineup-large-p-small-n.pdf}
\label{t2comp_1}
}
\subfigure[]{
\includegraphics[scale=0.55]{sep-dist-largep.pdf}
\label{t2comp_1}
}
\subfigure[]{
\includegraphics[scale=0.55]{bin-dist-largep-6-4.pdf}
\label{t2comp_2}
}
%\subfigure[]{
%\includegraphics[scale=0.55]{distribution-bin-dist-8-2-exp2.pdf}
...
\label{lp-exp}
	\vspace{-.1in}
\caption[Optional caption for list of figures]{Plot showing the lineup in (a) and the distribution of different distance metrics : separation based distance in (b) and  binned distance with 6 and 4 bins in x and y axis respectively in (d). The lineup corresponds to the point marked with a triangle in difference vs. detection rate plot in Figure \ref{lp-comp}.}
%{Caption of subfigures \subref{fig:subfig1}, \subref{fig:subfig2} and \subref{fig:subfig3}}
\end{figure}
